...
export default function Footer() {
  ...
  useEffect(() => {
    async function fetchVisitor() {
      try {
        // Memanggil API Route yang baru dibuat
        ...
        // Pastikan semua nilai adalah angka sebelum diset
        setStats({
        ...
        // Biarkan stats tetap 0 jika terjadi error
      }
    }
      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2">
            <li><a href="/artikel" className="text-white/80 hover:text-white">Artikel</a></li>
            <li><a href="/tentang-kami" className="text-white/80 hover:text-white">Tentang Kami</a></li>
            <li><a href="/kontak" className="text-white/80 hover:text-white">Kontak</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-5 text-2xl">
            <a href="https://instagram.com/artemisiacare" target="_blank" className="hover:text-gray-300">
              <FaInstagram />
            </a>
            <a href="mailto:info@artemisia.care" className="hover:text-gray-300">
              <FaEnvelope />
            </a>
          </div>
